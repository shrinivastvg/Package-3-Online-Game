const phaseQuestions = {
  ...
  { "question": "6. What infrastructure supports consistent water pressure and flow across the project area?", "options": ["SCADA systems", "Advanced pumping stations", "Overhead Tanks (OHTs)", "Collector wells"], "answer": "Overhead Tanks (OHTs)" },
  { "question": "7. What criteria were considered for selecting the location of the collector and infiltration wells in the case study given?", "options": ["Proximity to urban areas", "Availability of land for large-scale construction", "Ensuring year-round water availability from the Palar River", "Minimizing environmental disruptions"], "answer": "Ensuring year-round water availability from the Palar River" },
  ...
  { "question": "10. How does the Arithmetic Increase Method calculate the projected population for the case study given?", "options": ["By multiplying the current population by a growth rate", "By adding a fixed number to the population at regular intervals", "By dividing the population by the area", "By using a growth factor based on historical trends"], "answer": "By adding a fixed number to the population at regular intervals" },
  { "question": "11. How is the floating population demand calculated in terms of water supply for the case study given?", "options": ["By multiplying the floating population with 135 lpcd", "By using 10% of the floating population's requirement at 45 lpcd", "By dividing the total floating population by 10%", "By using 45 lpcd for 10% of the permanent population"], "answer": "By using 10% of the floating population's requirement at 45 lpcd" },
  ...
  { "question": "16. What specific criteria are considered to ensure the water source meets the ultimate water supply demand for the case study given?", "options": ["Proximity to power supply sources", "Sustainability in seasonal conditions, water yield, and ease of extraction", "Aesthetic quality and cleanliness of the riverbed", "Availability of land for residential and commercial use"], "answer": "Sustainability in seasonal conditions, water yield, and ease of extraction" },
  { "question": "17. What is the primary function of the SCADA system in this water supply project?", "options": ["To manually control water flow", "To monitor and automate the operation of pumps and valves", "To filter the water supply", "To store water in reservoirs"], "answer": "To monitor and automate the operation of pumps and valves" },
  { "question": "18. How does SCADA contribute to the efficiency of the water supply system in the case study given?", "options": ["By replacing the need for manual labor", "By enabling real-time monitoring and remote control of the water supply infrastructure", "By increasing the water pressure in the distribution system", "By reducing the need for water treatment"], "answer": "By enabling real-time monitoring and remote control of the water supply infrastructure" },
  { "question": "19. What regulatory framework ensures that the water supply improvement project in the case study given addresses environmental, social, and climate concerns?", "options": ["Environmental and Social Impact Assessment (ESIA)", "Environmental, Climate Change, and Social Management Framework (ECSMF)", "Environmental Protection Plan (EPP)", "Tamil Nadu Urban Development Fund (TNUDF) Policy Framework"], "answer": "Environmental, Climate Change, and Social Management Framework (ECSMF)" },
  ...
  { "question": "25. What international framework governs the climate resilience goals incorporated in the water project from the case study given?", "options": ["Kyoto Protocol", "Paris Agreement", "World Bank Environmental and Social Framework (ESF)", "UN Sustainable Development Goals (SDGs)"], "answer": "World Bank Environmental and Social Framework (ESF)" },
    ],
    intermediate: [
  ...
  { "question": "5. What environmental risk is associated with the installation of large pipelines and infrastructure for the project in the case study given?", "options": ["Soil erosion and habitat destruction due to excavation", "Improved biodiversity in the area", "Reduced use of water resources", "Increased vegetation growth"], "answer": "Soil erosion and habitat destruction due to excavation" },
  { "question": "6. What environmental impact could arise from the construction of overhead tanks (OHTs) in the case study given?", "options": ["Deforestation and loss of local flora and fauna", "Excessive rainfall leading to water scarcity", "Introduction of new water species", "Improved air quality in the area"], "answer": "Deforestation and loss of local flora and fauna" },
  ...
  { "question": "8. In the context of the water supply project in the case study given, which category of environmental and social risks would a sub-project involving the construction of 450 km of new HDPE distribution pipelines, 33 km of feeder mains, and 14 new OHTs fall under according to ECSMF's risk classification?", "options": ["High Risk", "Substantial Risk", "Moderate Risk", "Low Risk"], "answer": "Substantial Risk" },
  ...
  { "question": "10. What is a key climate-related risk when designing water supply infrastructure, such as pipelines and storage tanks, in the case study given?", "options": ["Infrastructure degradation due to increasing rainfall intensity and flooding", "Decreased energy consumption for pumping water", "Reduced costs for pipeline installation", "No impact on infrastructure stability"], "answer": "Infrastructure degradation due to increasing rainfall intensity and flooding" },
  { "question": "11. How might the water quality in the Palar River change due to climate change, affecting the project in the case study given?", "options": ["Decreased water salinity", "Increased contamination of water sources due to flooding and storm runoff", "No change in water quality", "Improved water quality"], "answer": "Increased contamination of water sources due to flooding and storm runoff" },
  ...
  { "question": "13. What social risk could arise due to the construction activities in the project described in the case study?", "options": ["Increased population growth in surrounding areas", "Displacement of street vendors and local businesses without proper compensation", "Reduced access to basic amenities", "Faster community development"], "answer": "Displacement of street vendors and local businesses without proper compensation" },
  { "question": "14. What social risk might arise if proper compensation and resettlement plans are not provided to communities affected by the project in the case study given?", "options": ["Increased community support for the project", "Loss of livelihood for displaced individuals leading to social unrest", "Improved community relations", "Enhanced job opportunities for displaced families"], "answer": "Loss of livelihood for displaced individuals leading to social unrest" },
