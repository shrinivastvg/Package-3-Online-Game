const phaseQuestions = {
    ...
    },
    {
        ...
        options: ["To finalize project budgets", "To avoid pipeline corrosion", "To ensure future water supply meets population needs", "To test pipeline durability"],
    ...
    },
    {
        ...
        options: ["Reservoir capacity", "Ground slope", "Pipe material", "Peak flow rate and velocity"],
    ...
    },
    {
        ...
        options: ["Purchase Order", "Bill of Quantities (BOQ)", "Tender Notice", "Specification Sheet"],
        answer: "Bill of Quantities (BOQ)"
    },
    {
        question: "Which pipe material is preferred for high-pressure water transmission?",
        options: ["Cast Iron", "Ductile Iron (DI)", "PVC", "HDPE"],
    ...
    },
    {
        ...
        options: ["Pipe diameter + 1.5 meters", "Pipe diameter + 0.6 meters", "Pipe diameter + 0.9 meters", "Pipe diameter + 0.3 meters"],
    ...
    commissioning: [
    {
        ...
        options: ["Calibrating flow meters", "Leakage detection", "Ensuring all tests meet design specifications", "Inspecting reservoirs"],
    ...
    },
    {
        ...
        options: ["Pressure gauges", "SCADA sensors", "Chlorinators", "Flow meters"],
        answer: "Flow meters"
    }
],
    projectExecution: [
    {
        ...
        options: ["Public Works Department", "Urban Development Authority", "Tamil Nadu Highways Department", "Revenue Department"],
    ...
    },
    {
        ...
        options: ["Tamil Nadu Highways Department", "Public Works Department", "Ministry of Road Transport and Highways", "National Highways Authority of India (NHAI)"],
    ...
    },
    {
        ...
        options: ["Revenue Department", "Public Works Department", "Tamil Nadu Infrastructure Development Board", "Commercial Taxes Department"],
    ...
    },
    {
        ...
        options: ["Smart City Portal", "TNeGA Road Cutting Portal", "Public Works E-Approval System", "Tamil Nadu e-Governance Portal"],
    ...
    },
    {
        ...
        options: ["Turbidity testing", "PH adjustment test", "Hardness compliance test", "Chlorination and bacteriological testing"],
        answer: "Chlorination and bacteriological testing"
    },
    {
        ...
        options: ["Tender Completion Report", "Tax Exemption Form", "Utility Clearance Document", "Work Completion Certificate"],
    ...
    },
    {
        ...
        options: ["Southern Railway Headquarters", "Indian Railways Urban Development Unit", "Public Works Railways Section", "Divisional Railway Manager’s Office"],
    ...
    },
    {
        ...
        options: ["Environmental Clearance Certificate", "Road Width Survey Report", "Utility Assessment Report", "No Objection Certificate (NOC)"],
...
function showCongratulationsPage() {
    ...
    let costExceeded = initialCost > 0 ? `₹${(initialCost / 1).toFixed(2)} crore` : "₹0 crore";
...
function updatePhase() {
    ...
    // Highlight the completed phase
    document.getElementById(`${currentPhase}-phase`).classList.add("completed");
